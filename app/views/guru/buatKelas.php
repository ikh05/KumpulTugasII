    ...
    <form method="POST" action="<?=BASE_URL?>Guru/simpanKelas">
		...
		<div class="input-group mb-3">
			<div class="form-floating">
				<input type="text" name="tokenKelas" placeholder='kode Unic' class="form-control" required autocomplete="off" aria-describedby="create-token">
				<label>Token Kelas</label>
			</div>
			<button class="btn btn-outline-secondary border-translucent" type="button" id="create-token">Random</button>
		</div>
		<div class="mb-3 form-floating">
			<input type="text" name="tahun" placeholder='contoh: "2022-2023"' value="2024-2025" readonly class="form-control" required autocomplete="off">
