        ...
        <div id="layoutSidenav">
            ...
            <div class="offcanvas offcanvas-start" data-bs-theme="dark" data-bs-scroll="true" tabindex="-1" id="id-offcanvas" aria-labelledby="offcanvasWithBothOptionsLabel">
                ...
                <div class="offcanvas-body">
                    <div class="nav flex-column text-secondary nav-underline gap-2">
                        ...
                        <?php foreach ($data['guru']['tokenKelas'] as $v) :?>
                            <a class="nav-link ms-3 py-0" data-bs-toggle="collapse" href="#<?= $v ?>" aria-controls="<?= $v ?>"role="button" aria-expanded="false"><i class="fa-solid fa-screen-users" ></i> <?= $data['kelas'][$v]['nama'] ?></a>
                            <div class="collapse ms-4" id="<?= $v ?>" aria-labelledby="headingTwo" data-bs-parent="#id-offcanvas">
                                <div class="list-group ">
                                  <a href="<?= BASE_URL ?>Guru/detailKelas/<?= $v ?>" class="list-group-item list-group-item-action <?= ($data['offcanvas'] === 'detailKelas_'.$v) ? 'active' : '' ?>"><i class="fa-solid fa-users"></i> Daftar Siswa</a>
                                  <a href="<?= BASE_URL ?>Guru/daftarSiswa/<?= $v ?>" class="list-group-item list-group-item-action <?= ($data['offcanvas'] === 'daftarSiswa_'.$v) ? 'active' : '' ?>"><i class="fa-solid fa-users"></i> Daftar Siswa</a>
                                  ...
                                  <a href="<?= BASE_URL ?>Guru/daftarNilai/<?= $v ?>" class="list-group-item list-group-item-action <?= ($data['offcanvas'] === 'daftarNilai_'.$v) ? 'active' : '' ?>"><i class="fa-solid fa-hundred-points"></i> Nilai</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="mb-3 border-primary border-top ps-2" style="width: inherit;">
